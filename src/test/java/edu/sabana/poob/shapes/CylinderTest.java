...
public class CylinderTest {
    ...
    public void shouldCalculateSuperficialArea() {
        ...
        assertEquals(39, (int) c1.getSuperficialArea());
        assertEquals(120354, (int) c2.getSuperficialArea());
        assertEquals(512345, (int) c3.getSuperficialArea());
    }
    @Test
    ...
    public void shouldNorCreateCircleWithRadiusNegative() {
        ...
        public void shouldNorCreateCircleWithRadiusZero() {
            ...
            Exception e = assertThrows(ShapeException.class, () -> new Cylinder(0));
            assertEquals(ShapeException.BAD_DIMENSION_SIDE, e.getMessage());
        }
