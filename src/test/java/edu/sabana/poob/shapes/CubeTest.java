...
public class CubeTest {
    ...
    public void shouldCalculateVolume() {
        assertEquals(0.0, (int) c1.getVolume());
        assertEquals(0.0, (int) c2.getVolume());
    ...
    public void shouldCalculateSuperficialArea() {
        assertEquals(0.0, (int) c1.getSuperficialArea());
        assertEquals(0.0, (int) c2.getSuperficialArea());
    ...
    public void shouldCalculateArea() {
        assertEquals(0.0, (int) c1.getArea());
        assertEquals(0.0, (int) c2.getArea());
    ...
    public void shouldCalculatePerimeter() {
        assertEquals(0.0, (int) c1.getPerimeter());
        assertEquals(0.0, (int) c2.getPerimeter());
